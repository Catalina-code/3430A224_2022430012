...
private:
    ...
    // Metodo recursivo para insertar un nodo en el árbol binario de búsqueda
    ...
    // Función recorrer el árbol y escribir en el archivo para el grafo
